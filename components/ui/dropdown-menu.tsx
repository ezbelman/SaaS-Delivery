...
>(({ className, sideOffset = 6, ...props }, ref) => (
  <DropdownMenuPortal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "z-50 min-w-[180px] overflow-hidden rounded-lg border border-[var(--line)] bg-elevated p-1 shadow-xl",
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    ref={ref}
    className={cn(
      "px-2.5 py-1.5 text-xs font-medium uppercase tracking-wider text-ink-3",
      inset && "pl-8",
      className
    )}
    {...props}
